        ...
        <form onSubmit={handleVerifyOtp} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="123456"
              className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-center text-black text-xl tracking-widest focus:outline-none focus:ring-2 focus:ring-[#8b5cf6]"
            />
          </div>
